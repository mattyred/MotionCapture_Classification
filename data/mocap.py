...
class MocapDataset(object):
    def __init__(self, data_path="data/mocap/",
                 ...
                 pca_normalize=True,
                 small_skeleton=False):
        self.data_path = data_path
        self.dt = dt
        self.pca_components = pca_components
        self.data_normalize = data_normalize
        self.pca_normalize = pca_normalize
        self.small_skeleton = small_skeleton

        assert subject in ["09", "09_m1", "35", "39"], "Wrong subject passed"
        fname = os.path.join(data_path, "mocap" + subject + ".npz") if self.small_skeleton is False else os.path.join(data_path, "mocap" + subject + "_small_skeleton.npz")
        ...
        if self.small_skeleton is False:
    ...
    def treat_zero_readings(self, data):
        data[:, :, (7, 11)] = 1e-6#data[:, :, (24, 25, 31, 32)] = 1e-6
        return data
